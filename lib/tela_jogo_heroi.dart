        ...
        Center(
          child: Column(
            children: [
              ...
              Row(
                children: [
                  ElevatedButton(onPressed: () => escolhaHeroi("Guerreiro"), child: Text("Guerreiro"),
                  ),
                  ElevatedButton(onPressed: () => escolhaHeroi("Ladino"), child: Text("Ladino"),
                  ),
                  ElevatedButton(onPressed: () => escolhaHeroi("Mago"), child: Text("Mago"),
                  ),
                ],
              ),
              Card(
  ...
  void escolhaHeroi(String tipoHeroi) {
    setState(() {
      if (tipoHeroi == "Guerreiro") {
        ...
        poder = 70;
        inteligencia = 50;
        urlImagem = "https://thumb.wikimedia.org/wikipedia/commons/thumb/3/37/Jair_Bolsonaro_2019_Portrait_%283x4_cropped_center%29.jpg/330px-Jair_Bolsonaro_2019_Portrait_%283x4_cropped_center%29.jpg?utm_source=pt.wikipedia.org&utm_campaign=parser&utm_content=thumbnail";
        ...
        poder = 150;
        inteligencia = -1;
        urlImagem = "https://ichef.bbci.co.uk/ace/ws/640/cpsprodpb/8d1a/live/f611e8b0-5566-11f1-ab55-37e8d4cd836a.jpg.webp";
      } else if (tipoHeroi == "Mago"){
        nomeHeroi = "Daniel Vorcaro";
        titulo = "O mago do dinheiro";
        vida = 80;
        moedas = 999999999999999999;
        poder = 300;
        inteligencia = 1000;
        urlImagem = "https://admin.cnnbrasil.com.br/wp-content/uploads/sites/12/2026/02/Daniel-Vorcaro.png?w=1000";
      }
    }
  }
}
